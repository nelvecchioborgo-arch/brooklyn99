...
import { C as useQueryClient, z as onlineManager } from "./modern-DpHDIv-m.js";
import { t as require_jsx_runtime } from "./react_jsx-runtime.js";
import { G as setupStyleSheet, I as mergeProps, P as lazy, V as render, m as createComponent, x as createSignal } from "./M4GWWVAC-offoCj-c.js";
	...
	mount(el) {
		...
		const dispose = render(() => {
			...
			if (this.#Component) Devtools = this.#Component;
				...
				Devtools = lazy(() => import("./SO26Z5QU-BcgUPj1t.js"));
	...
	mount(el) {
		...
		const dispose = render(() => {
			...
			if (this.#Component) Devtools = this.#Component;
				...
				Devtools = lazy(() => import("./MYKLHYJZ-D_XhX_HM.js"));
				this.#Component = Devtools;
			}
			setupStyleSheet(this.#styleNonce, this.#shadowDOMTarget);
			return createComponent(Devtools, mergeProps({
